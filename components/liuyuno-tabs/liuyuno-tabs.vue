<template>
	<view class="_tab-box" :style="{height: defaultConfig.height, lineHeight: defaultConfig.lineHeight, background: defaultConfig.background, fontSize: defaultConfig.fontSize + 'rpx', color: defaultConfig.color}">
		<scroll-view id="_scroll" :scroll-x="true" class="scroll-view-h" scroll-with-animation :scroll-left="slider.scrollLeft">
			<view class="_scroll-content">
				...
				<view class="_underline" :style="{
						...
						backgroundImage: defaultConfig.underLineBackgroundImage,
						backgroundColor: defaultConfig.underLineColor,
						bottom: defaultConfig.underLineBottom
					}" />
			</view>
		</scroll-view>
	</view>
		...
		data() {
			return {
				...
				defaultConfig: {
					...
					underLineHeight: 6,
					// 下划线渐变色
					underLineBackgroundImage: 'linear-gradient(270deg, #F7970D 0%, #FFD678 100%)',
				},
			};
		},
		watch: {
